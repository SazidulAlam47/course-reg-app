        ...
        <div className="card">
            <div className="course-img">
                ...
                <div className='price-credit'> 
                    <img src={dollarSign} style={{width:"15px"}} alt="$" className='icon' /> <span style={{marginRight:"20px"}}>Price: {course.price} </span> 
                    <img src={bookSign} style={{width:"23px"}} className='icon'/>  Credit: {course.credit}hr
                </div>
